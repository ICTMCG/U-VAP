...
parser.add_argument('--nontar_model_path', type=str)
...
output_path = f"{args.model_path}/output_TI"
SEED = args.seed
torch.manual_seed(SEED)
pipe = StableDiffusionPipeline.from_pretrained(args.base_model, torch_dtype=torch.float16,safety_checker=None,
                                                requires_safety_checker=False,).to(device)
pipe.load_textual_inversion(args.model_path)
pipe.load_textual_inversion(args.nontar_model_path)
